    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a href="{{route('meditation.create')}}" class="btn btn-icons btn-success float-right"><i
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('meditation.edit',$val->id)}}" class="btn btn-icons btn-primary"><i
                                            class="mdi mdi-pencil"></i></a>

                                    <form action="{{ route('meditation.destroy', $val->id) }}" method="POST"
