    ...
    <div class="col-md-10 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" action="{{route('schedule.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="form-group"><label for="image">Poster Image</label>
                ...
                <div class="form-group"><label for="start_time">Start time</label>
                    <input type="time" id="start_time" placeholder="Start time" name="start_time" class="form-control" value="{{ old('start_time') }}" >
                ...
                <div class="form-check"><label class="form-check-label"><input type="checkbox" name="status" checked="{{ old('status')==1  ? 'checked' : ''}}" class="form-check-input"> Status <i class="input-helper"></i></label></div>
