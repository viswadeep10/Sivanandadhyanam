...
<body>
  ...
  <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center">
    <a class="navbar-brand brand-logo" href="#">
      <img src="{{asset('assets/backend/images/logo.png')}}" alt="logo" /> </a>
    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item dropdown d-none d-xl-inline-block">
        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          ...
          <img class="img-xs rounded-circle" src="{{asset('assets/backend/images/profile.png')}}" alt="Profile image"> </a>
...
<div id="right-sidebar" class="settings-panel">
  ...
  <ul class="chat-list">
    <li class="list active">
      <div class="profile">
        <img src="{{asset('assets/backend/images/faces/face3.jpg')}}" alt="image">
    ...
    <li class="list">
      <div class="profile">
        <img src="{{asset('assets/backend/images/faces/face2.jpg')}}" alt="image">
    ...
    <li class="list">
      <div class="profile">
        <img src="{{asset('assets/backend/images/faces/face4.jpg')}}" alt="image">
        <span class="offline"></span>
      </div>
      <div class="info">
    ...
    <li class="list">
      <div class="profile">
        <img src="{{asset('assets/backend/images/faces/face6.jpg')}}" alt="image">
        <span class="online"></span>
      </div>
      <div class="info">
        <p>Sarah Graves</p>
