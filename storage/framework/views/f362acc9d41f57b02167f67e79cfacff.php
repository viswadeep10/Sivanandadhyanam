    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <a href="<?php echo e(route('schedule.create')); ?>" class="btn btn-icons btn-success float-right"><i
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('schedule.edit',$val->id)); ?>" class="btn btn-icons btn-primary"><i
                                            class="mdi mdi-pencil"></i></a>

                                    <form action="<?php echo e(route('schedule.destroy', $val->id)); ?>" method="POST"
...
<?php echo $__env->make('admin.layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u691775676/domains/sivanandadhyanam.in/public_html/resources/views/admin/schedule/index.blade.php ENDPATH**/ ?>