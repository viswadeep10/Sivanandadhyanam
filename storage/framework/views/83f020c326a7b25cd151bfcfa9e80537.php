...
<nav id="navbar-example2" class="navbar navbar-expand-lg navbar-light">
    <div class="container">
        <a class="navbar-brand fw-bold fs-3" href="/public">
            <img src="<?php echo e(asset('assets/front/img/logo.png')); ?>">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            ...
            <li class="nav-item"><a class="nav-link" href="/public">Home</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="#"><img src="<?php echo e(asset('assets/front/img/language.png')); ?>"> English</a></li>
            </ul>
            <?php if(!Auth::check()): ?>
            <div class="d-flex gap-3 mr-t">
                <a class="btn-primary" data-bs-toggle="modal" href="#SignUp" role="button"><img src="<?php echo e(asset('assets/front/img/avatar-white.png')); ?>"> Register Now</a>
            </div>
            <?php else: ?>
            <div class="d-flex gap-3 mr-t">
                <a class="btn-primary" href="<?php echo e(route('custom_logout')); ?>" role="button"><img src="<?php echo e(asset('assets/front/img/logout.png')); ?>"> Logout</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
</nav>
<?php /**PATH /home/u691775676/domains/sivanandadhyanam.in/public_html/resources/views/front/layouts/header.blade.php ENDPATH**/ ?>